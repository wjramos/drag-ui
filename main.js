...
var Element = function () {
    function Element() {
        ...
        var frame = this.frame = element.frame || {};
        this.unique_id = element.unique_id;
        this.type = element.type;
        this.parent = parent || { $elem: (0, _jquery2.default)('.phone') };
        this.children = [];

        // Create DOM element -- store initial state
        this.$elem = (0, _jquery2.default)('<div />', {
            id: this.unique_id || '',
            class: 'tile',
        ...
        if (element.elements) {
            element.elements.forEach(function (element) {
                return _this.children.push(new Element(element, _this));
            });
        }
        ...
        value: function delegate() {
            ...
            $elem.on('drop', function (event, ui) {
                ...
                if (self.$elem.parent()[0] !== self.parent.$elem[0]) {
                    var parentOffset = self.parent.$elem.offset();
                    var offset = self.$elem.offset();

                    /* Recalculate offset -- Reset draggable bounds -- connect to new parent */
                    self.$elem.detach().css('top', offset.top - parentOffset.top).css('left', offset.left - parentOffset.left).draggable('option', { containment: 'parent' }).droppable('option', { hoverClass: 'drop-hover' }).appendTo(self.parent.$elem);
                }
            });

            $elem.on('dropover', function (event, ui) {
                /* Update parent when context changes */
                return self.parent.$elem = self.bind((0, _jquery2.default)(this).droppable('option', { hoverClass: 'drop-hover' }));
            });
...
},{"jquery":2,"jquery-ui":1}],4:[function(require,module,exports){
'use strict';
...
var Page = function () {
    ...
    function Page() {
        ...
        elements.forEach(function (element) {
            return _this.elements.push(new _Element2.default(element));
        });
    ...
    _createClass(Page, [{
        ...
        value: function addElement(element) {
            this.elements.push(new _Element2.default(element));
...
// Separated out data from page model -- this could be delivered through a NoSQL database or by JSON
...
(0, _jquery2.default)(function () {
  return new _Page2.default(_data2.default).draw();
});

},{"./Page":4,"./data":5,"jquery":2}]},{},[6])
